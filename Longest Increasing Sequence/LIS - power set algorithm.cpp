// Longest increasing subsequence problem, power set algorithm 
// Author: YL
...
int main() {
	...
	int *bestSet;
	// display the header 
	cout << endl << "CPSC 335-2 - Programming Assignment #2" << endl;
